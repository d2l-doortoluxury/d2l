            ...
            <div class="row row-cards">
                                ...
                                <div class="col-xl-12">
                                    <div class="row">
                                        <div class="alert alert-success">
                                            ...
                                            <p>{{ __('IMPORTANT: Before starting this process, we recommend you to take
                                                a backup of your files.')}}</p>
                                            @endif
                                        </div>
                ...
                <div class="col-sm-12 col-lg-4 d-block">
                    ...
                    <a href="https://codecanyon.net/cart/configure_before_adding/33165916?license=extended&ref=nativecode&size=source"
                        ...
                        <img class="mt-3" src="{{ asset('backend/img/upgrade-to-extended-license.png')}}"
