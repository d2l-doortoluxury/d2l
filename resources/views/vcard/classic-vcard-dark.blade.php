                        ...
                        <div class="w-full lg:w-full p-4">
                            <div class="p-3 bg-dark shadow-lg rounded-lg">
                                ...
                                <div class="w-full mb-1 mt-1 justify-between items-center">
                                    <div>
                                        <h3 id="{{ $product_detail->product_id }}_product_name" class="text-sm font-medium text-white">
                                            {{ $product_detail->product_name }}</h3>
                                        <span id="{{ $product_detail->product_id }}_subtitle" class="text-xs text-white">{{
                                            $product_detail->product_subtitle }}</span>
                                    </div>
                                </div>
                                <div class="w-full mb-1 justify-between items-center">
                                    <h4 class="text-sm mb-3 font-bold text-white"><span id="{{ $product_detail->product_id }}_currency">{{ $product_detail->currency }}</span> <span id="{{ $product_detail->product_id }}_price">{{
                    ...
                    @if ($business_hours != null && $business_hours->is_display != 0)
                        ...
                        <div class="px-5 py-4">
                            ...
                            @if ($business_hours->is_always_open != 'Opening')
                                <div>
                                    <p class="pt-2 font-semibold text-white">{{ __('Monday') }}: {{ __($business_hours->Monday) }}</p>
                                    <p class="pt-2 font-semibold text-white">{{ __('Tuesday') }}: {{ __($business_hours->Tuesday) }}</p>
                                    <p class="pt-2 font-semibold text-white">{{ __('Wednesday') }}: {{ __($business_hours->Wednesday) }}</p>
                                    <p class="pt-2 font-semibold text-white">{{ __('Thursday') }}: {{ __($business_hours->Thursday) }}</p>
                                    <p class="pt-2 font-semibold text-white">{{ __('Friday') }}: {{ __($business_hours->Friday) }}</p>
                                    <p class="pt-2 font-semibold text-white">{{ __('Saturday') }}: {{ __($business_hours->Saturday) }}</p>
                                    <p class="pt-2 font-semibold text-white">{{ __('Sunday') }}: {{ __($business_hours->Sunday) }}</p>
                                </div>
                            @else
                                <div>
                            ...
                            <div class="">
                              ...
                              <form action="{{ route('sent.enquiry') }}" method="POST">
                                ...
                                <div class="mb-6 flex p-4 bg-gray-50 rounded">
                                  <textarea
                                    class="w-full h-20 text-xs font-semibold bg-gray-50 rounded outline-none"
                                    type="text"
