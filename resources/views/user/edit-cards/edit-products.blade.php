        ...
        <div class="container-xl">
            <div class="row row-deck row-cards">
                <div class="col-sm-12 col-lg-12">
                    <form action="{{ route('user.update.vproducts', Request::segment(3)) }}" method="post"
                                ...
                                <div class="col-xl-12">
                                    ...
                                    <div class="row">
                                        ...
                                        @for ($i = 0; $i < count($products); $i++) <div class='row' id="{{ $i }}">
                                            ...
                                            <div class="col-md-6 col-xl-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select name="currency[]" id="currency" class="form-control">
                                                        ...
                                                        <option value="{{ $currency->iso_code }}" {{ $products[$i]->
                                                            currency
                                                            == $currency->iso_code || $products[$i]->currency ==
                                                ...
                                                <div class='mb-3'>
                                                    ...
                                                    <div class='input-group mb-2'>
                                                        ...
                                                        <button class='btn btn-primary btn-md' type='button'
                                                            onclick="openMedia({{ $products[$i]->id }})">{{ __('Choose
                                                            image') }}</button>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class='col-md-6 col-xl-6'>
                                                <div class='mb-3'>
                                                    <label class='form-label required'>{{ __('Product Sub Title')
                                                        }}</label>
                                                    <textarea class='form-control' name='product_subtitle[]'
                                                        data-bs-toggle='autosize' placeholder='{{ __(' Product Sub
                                                        Title') }}...'
                                                        required>{{ $products[$i]->product_subtitle }}</textarea>
                                                </div>
                                            </div>
                                            <div class='col-md-6 col-xl-6'>
                                                <div class='mb-3'><label class='form-label required'>{{ __('Regular
                                                    ...
                                                    <input type='number' class='form-control' name='regular_price[]'
                                                        ...
                                                        value="{{ $products[$i]->regular_price }}" min='1' step='.001'
                                                        required>
                                                </div>
                                            </div>
                                            <div class='col-md-6 col-xl-6'>
                                                <div class='mb-3'>
                                                    ...
                                                    <input type='number' class='form-control' name='sales_price[]'
                                                        min='1' step='.001' value="{{ $products[$i]->sales_price }}"
                                            ...
                                            <div class='col-md-6 col-xl-6'>
                                                <div class='mb-3'>
                                                    ...
                                                    <select name='product_status[]' id='product_status'
                                                        ...
                                                        <option value='instock' {{ $products[$i]->product_status ==
                                                            "instock" ? "selected" : "" }}>
                                                            {{ __('In Stock') }}</option>
                                                        <option value='outstock' {{ $products[$i]->product_status ==
                                                            "outstock" ? "selected" : "" }}>
        ...
        var products = `<div class='row' id=`+ id +`>
            ...
            <div class='col-md-6 col-xl-6'>
                <div class='mb-3'>
                    ...
                    <input type='number' class='form-control' name='regular_price[]' min='1' step='.001' placeholder='{{ __('Regular Price') }}...' required>
                </div>
            </div>
