                        ...
                        <div class="card">
                            <div class="card-body p-4 text-center">
                                <span class="img-rounded">
                                    <img src="{{ asset(Auth::user()->profile_image == '' ? 'backend/img/favicon.png' : auth::user()->profile_image) }}" alt="{{ auth::user()->name }}">
                                </span>
                                ...
                                <div class="mt-3">
                                    <span
                                        class="badge bg-green-lt">{{ __($account_details->role_id == 2 ? 'Customer' : '') }}</span>
                                </div>
                            </div>
                            <div class="d-flex">
