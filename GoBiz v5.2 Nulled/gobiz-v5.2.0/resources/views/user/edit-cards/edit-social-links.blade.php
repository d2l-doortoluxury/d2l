        ...
        <div class="container-xl">
            <div class="row row-deck row-cards">
                <div class="col-sm-12 col-lg-12">
                    <form action="{{ route('user.update.social.links', Request::segment(3)) }}" id="myForm"
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        ...
                                        @for ($i = 0; $i < count($features); $i++) <div class='row' id="{{ $i }}">
                                            ...
                                            <div class='col-lg-2 col-md-2'>
                                                <div class='mb-3 mt-2'>
                                                    <label class='form-label required' for='type'>{{ __('Display type')
                                                        }}</label>
                                                    <select name='type[]' id='type'
                                                        ...
                                                        <option value='text' {{ $features[$i]->type == 'text' ||
                                                            $features[$i]->type == 'textarea' ? 'selected' : '' }}>
                                                            {{ __('Default') }}</option>
                                                        <option value='address' {{ $features[$i]->type == 'address' ?
                                                            'selected' : '' }}>
                                                            {{ __('Address') }}</option>
                                                        <option value='email' {{ $features[$i]->type == 'email' ?
                                                            'selected' : '' }}>
                                                            {{ __('Email') }}</option>
                                                        <option value='tel' {{ $features[$i]->type == 'tel' ? 'selected'
                                                            : '' }}>
                                                            {{ __('Phone') }}</option>
                                                        <option value='wa' {{ $features[$i]->type == 'wa' ? 'selected' :
                                                            '' }}>
                                                            {{ __('WhatsApp') }}</option>
                                                        <option value='url' {{ $features[$i]->type == 'url' ? 'selected'
                                                            : '' }}>
                                                            {{ __('Link') }}</option>
                                                        <option value='youtube' {{ $features[$i]->type == 'youtube' ?
                                                            'selected' : '' }}>
                                                            {{ __('Youtube Video') }}</option>
                                                        <option value='map' {{ $features[$i]->type == 'map' ? 'selected'
                                                            : '' }}>
                                            ...
                                            <div class='col-lg-3 col-md-3'>
                                                <div class='mb-3 mt-2'>
                                                    ...
                                                    <input type='text' class='lbl{{ $features[$i]->id }} form-control'
...
<script>
    ...
    function changeLabel(id) {
        ...
        if(type == 'address') {
            ...
            label = `{{ __('California') }}`;
            textlabel = `{{ __("For ex: <iframe src='https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3924.7798234706065!2d77.98194106479716!3d10.359482142605264!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b00ab9baf4b4101%3A0x9d6d57a812be5cc6!2sCapsimint%20Technologies%20-%20Web%2C%20Mobile%20App%20and%20Software%20Development%20Company!5e0!3m2!1sen!2sin!4v1638283593135!5m2!1sen!2sin'></iframe>") }}`;
        }
