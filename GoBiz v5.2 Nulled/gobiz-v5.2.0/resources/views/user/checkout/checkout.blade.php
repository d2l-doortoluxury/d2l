                                ...
                                <table class="table table-vcenter">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-bold"> {{ $currency->symbol }}{{ number_format((int)$selected_plan->plan_price * (int)$config[25]->config_value / 100, 2) }}
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="w-1 text-bold h3"> {{ $currency->symbol }}{{ number_format($total, 2) }}
                                            </td>
                                        </tr>
                                            ...
                                            <div class="col-md-4 col-xl-4">
                                                <div class="mb-3">
                                                    <label class="form-label">{{ __('Billing Address') }} <span
                                                            class="text-danger">*</span></label>
                                                    <input type="tel" class="form-control" name="billing_address" id="billing_address"
                                                                ...
                                                                <div class="form-selectgroup form-selectgroup-boxes d-flex flex-column">
                                                                    <label class="form-selectgroup-item flex-fill">
                                                                        <input type="radio" name="payment_gateway_id"
                                                                            value="{{ $gateway->payment_gateway_id }}" class="form-selectgroup-input">
                                                                        <div class="form-selectgroup-label d-flex align-items-center p-3">
                                                                            ...
                                                                            <div>
                                                                                <div class="font-weight-medium h4">{{ __($gateway->display_name) }}</div>
                                                                            </div>
                                                                        </div>
                                                                    </label>
                                                                </div>
