                        ...
                        <div class="card">
                            <div class="card-body p-4 text-center">
                                <span class="avatar avatar-xl mb-3 bg-white">
                                    <img src="{{ asset(auth::user()->profile_image == null ? 'backend/img/favicon.png' : auth::user()->profile_image) }}"
                                        alt="{{ auth::user()->name }}">
                                </span>
                                ...
                                <div class="mt-3">
                                    <span class="badge bg-green-lt">{{ __($account_details->role_id == 1 ?
                                        __('Administrator') : '') }}</span>
                                </div>
                            </div>
                            <div class="d-flex">
