                                        ...
                                        <span class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end" style="">
                                                ...
                                                <a class="dropdown-item" href="#"
                                                    onclick="getOfflineTransaction('{{ $transaction->gobiz_transaction_id }}'); return false;">{{
                                                    __('Success') }}</a>
                                                @endif
                                                @if ($transaction->payment_status != "PENDING")
                                                <a class="dropdown-item"
                                                    href="{{ route('admin.offline.trans.status', ['id' => $transaction->gobiz_transaction_id, 'status' => 'PENDING'])}}">{{
                                                    __('Pending') }}</a>
                                                @endif
                                                @if ($transaction->payment_status != "FAILED")
                                                <a class="dropdown-item"
                                                    href="{{ route('admin.offline.trans.status', ['id' => $transaction->gobiz_transaction_id, 'status' => 'FAILED'])}}">{{
                                                    __('Failed') }}</a>
                                                @endif
                                            </div>
                                        </span>
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div>{{ __('If you proceed with this transaction, If you proceed with this transaction, you will have
                    payment status success and activate this plan.')}}</div>
            </div>
