    ...
    public function prepareMollie($planId)
    {
        if (Auth::user()) {
            ...
            if ($plan_details == null) {
                ...
                $gobiz_transaction_id = rand(1, 9999999999999999);
                ...
                // Transaction ID
                $transactionId = rand(1, 9999999999999999);
                ...
                try {
                    ...
                    alert()->error(trans('The mollie token has expired. Please refresh the page and try again.'));
